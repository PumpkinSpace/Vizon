...
var ApplicationOperations = ( /** @lends ApplicationOperations */ function() {
   ...
   * 
   * @param {IEnumerable} [parameters.credentials] Gets or sets the list of
  ...
  ApplicationOperations.prototype.create = function(parameters, callback) {
    ...
    if (parameters.credentials !== null && parameters.credentials !== undefined) {
      for (var loweredIndex1 = 0; loweredIndex1 < parameters.credentials.length; loweredIndex1 = loweredIndex1 + 1) {
        var credentialsParameterItem = parameters.credentials[loweredIndex1];
        if (credentialsParameterItem.endDate === null || credentialsParameterItem.endDate === undefined) {
          return callback(new Error('parameters.credentials.endDate cannot be null.'));
        }
        if (credentialsParameterItem.keyId === null || credentialsParameterItem.keyId === undefined) {
          return callback(new Error('parameters.credentials.keyId cannot be null.'));
        }
        if (credentialsParameterItem.startDate === null || credentialsParameterItem.startDate === undefined) {
          return callback(new Error('parameters.credentials.startDate cannot be null.'));
        }
      }
    }
    ...
    // Construct URL
    var url2 = '/' + this.client.tenantID.trim() + '/applications?';
    ...
    if (parameters.identifierUris !== null && parameters.identifierUris !== undefined) {
      ...
      for (var loweredIndex2 = 0; loweredIndex2 < parameters.identifierUris.length; loweredIndex2 = loweredIndex2 + 1) {
        var identifierUrisItem = parameters.identifierUris[loweredIndex2];
    ...
    if (parameters.replyUrls !== null && parameters.replyUrls !== undefined) {
      var replyUrlsArray = [];
      for (var loweredIndex3 = 0; loweredIndex3 < parameters.replyUrls.length; loweredIndex3 = loweredIndex3 + 1) {
        var replyUrlsItem = parameters.replyUrls[loweredIndex3];
    ...
    if (parameters.credentials !== null && parameters.credentials !== undefined) {
      ...
      for (var loweredIndex4 = 0; loweredIndex4 < parameters.credentials.length; loweredIndex4 = loweredIndex4 + 1) {
        var passwordCredentialsItem = parameters.credentials[loweredIndex4];
   ...
   * @returns {Stream} The response stream.
   */
  ApplicationOperations.prototype.delete = function(applicationObjectId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = '/' + this.client.tenantID.trim() + '/applications/' + applicationObjectId.trim() + '?';
    url2 = url2 + 'api-version=1.42-previewInternal';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var GroupOperations = ( /** @lends GroupOperations */ function() {
  ...
  GroupOperations.prototype.list = function(mail, displayNameStartsWith, callback) {
    ...
    if (mail !== null && mail !== undefined) {
      appendFilter = false;
      url2 = url2 + '$filter=' + 'mail eq \'' + encodeURIComponent(mail !== null && mail !== undefined ? mail.trim() : '') + '\'';
    }
    if (displayNameStartsWith !== null && displayNameStartsWith !== undefined) {
      url2 = url2 + '&$filter=startswith(displayName,\'' + encodeURIComponent(displayNameStartsWith !== null && displayNameStartsWith !== undefined ? displayNameStartsWith.trim() : '') + '\')';
    }
    url2 = url2 + '&api-version=1.42-previewInternal';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
...
var ServicePrincipalOperations = ( /** @lends ServicePrincipalOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  ServicePrincipalOperations.prototype.delete = function(objectId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
