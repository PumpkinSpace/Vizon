...
var WebSiteManagementClient = ( /** @lends WebSiteManagementClient */ function() {
  ...
  WebSiteManagementClient.prototype.getOperationStatus = function(webSpaceName, siteName, operationId, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.credentials.subscriptionId !== null && this.credentials.subscriptionId !== undefined ? this.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + siteName.trim() + '/operations/' + operationId.trim();
...
var WebHostingPlanOperations = ( /** @lends WebHostingPlanOperations */ function() {
  ...
  WebHostingPlanOperations.prototype.create = function(webSpaceName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/ServerFarms';
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serverFarmElement2 !== null && serverFarmElement2 !== undefined) {
          ...
          if (numberOfWorkersElement2 !== null && numberOfWorkersElement2 !== undefined && (numberOfWorkersElement2 === null || numberOfWorkersElement2 === undefined || numberOfWorkersElement2.length === 0) === false) {
          ...
          if (sKUElement2 !== null && sKUElement2 !== undefined) {
          ...
          if (workerSizeElement2 !== null && workerSizeElement2 !== undefined && (workerSizeElement2 === null || workerSizeElement2 === undefined || workerSizeElement2.length === 0) === false) {
   ...
   * @returns {Stream} The response stream.
   */
  WebHostingPlanOperations.prototype.delete = function(webSpaceName, webHostingPlanName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/ServerFarms/' + webHostingPlanName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (serverFarmElement !== null && serverFarmElement !== undefined) {
          ...
          if (numberOfWorkersElement !== null && numberOfWorkersElement !== undefined && (numberOfWorkersElement === null || numberOfWorkersElement === undefined || numberOfWorkersElement.length === 0) === false) {
          ...
          if (workerSizeElement !== null && workerSizeElement !== undefined && (workerSizeElement === null || workerSizeElement === undefined || workerSizeElement.length === 0) === false) {
  ...
  WebHostingPlanOperations.prototype.getHistoricalUsageMetrics = function(webSpaceName, webHostingPlanName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/serverFarms/' + webHostingPlanName.trim() + '/metrics?';
          ...
          if (metricResponsesElement !== null && metricResponsesElement !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, metricResponsesElement, 'METRICRESPONSE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (dataElement !== null && dataElement !== undefined) {
                ...
                if (endTimeElement !== null && endTimeElement !== undefined) {
                ...
                if (valuesSequenceElement !== null && valuesSequenceElement !== undefined) {
                  for (var loweredIndex2 = 0; loweredIndex2 < js2xml.getElements(responseDoc, valuesSequenceElement, 'METRICSAMPLE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex2 = loweredIndex2 + 1) {
                    ...
                    if (countElement !== null && countElement !== undefined) {
                    ...
                    if (timeCreatedElement !== null && timeCreatedElement !== undefined) {
...
var WebSiteOperations = ( /** @lends WebSiteOperations */ function() {
  ...
  WebSiteOperations.prototype.applySlotConfiguration = function(webSpaceName, webSiteName, targetSwapSlot, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/applySlotConfig?';
    url2 = url2 + 'targetSwapSlot=' + encodeURIComponent(targetSwapSlot.trim());
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.backup = function(webSpaceName, webSiteName, backupRequest, callback) {
    ...
    if (backupRequest.backupSchedule !== null && backupRequest.backupSchedule !== undefined) {
      if (backupRequest.backupSchedule.frequencyInterval === null || backupRequest.backupSchedule.frequencyInterval === undefined) {
        return callback(new Error('backupRequest.backupSchedule.frequencyInterval cannot be null.'));
      }
      if (backupRequest.backupSchedule.keepAtLeastOneBackup === null || backupRequest.backupSchedule.keepAtLeastOneBackup === undefined) {
        return callback(new Error('backupRequest.backupSchedule.keepAtLeastOneBackup cannot be null.'));
      }
      if (backupRequest.backupSchedule.retentionPeriodInDays === null || backupRequest.backupSchedule.retentionPeriodInDays === undefined) {
        return callback(new Error('backupRequest.backupSchedule.retentionPeriodInDays cannot be null.'));
      }
    }
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/backup';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (backupItemElement !== null && backupItemElement !== undefined) {
          ...
          if (createdElement !== null && createdElement !== undefined && (createdElement === null || createdElement === undefined || createdElement.length === 0) === false) {
          ...
          if (scheduledElement !== null && scheduledElement !== undefined) {
          ...
          if (lastRestoreTimeStampElement !== null && lastRestoreTimeStampElement !== undefined && (lastRestoreTimeStampElement === null || lastRestoreTimeStampElement === undefined || lastRestoreTimeStampElement.length === 0) === false) {
          ...
          if (finishedTimeStampElement !== null && finishedTimeStampElement !== undefined && (finishedTimeStampElement === null || finishedTimeStampElement === undefined || finishedTimeStampElement.length === 0) === false) {
  ...
  WebSiteOperations.prototype.beginSwappingSlots = function(webSpaceName, webSiteName, sourceSlotName, targetSlotName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '(' + sourceSlotName.trim() + ')/slots?';
  ...
  WebSiteOperations.prototype.create = function(webSpaceName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (siteElement2 !== null && siteElement2 !== undefined) {
          ...
          if (adminEnabledElement !== null && adminEnabledElement !== undefined && (adminEnabledElement === null || adminEnabledElement === undefined || adminEnabledElement.length === 0) === false) {
          ...
          if (availabilityStateElement !== null && availabilityStateElement !== undefined && (availabilityStateElement === null || availabilityStateElement === undefined || availabilityStateElement.length === 0) === false) {
          ...
          if (enabledElement !== null && enabledElement !== undefined && (enabledElement === null || enabledElement === undefined || enabledElement.length === 0) === false) {
          ...
          if (hostNameSslStatesSequenceElement !== null && hostNameSslStatesSequenceElement !== undefined) {
            for (var loweredIndex2 = 0; loweredIndex2 < js2xml.getElements(responseDoc, hostNameSslStatesSequenceElement, 'HOSTNAMESSLSTATE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex2 = loweredIndex2 + 1) {
              ...
              if (sslStateElement !== null && sslStateElement !== undefined && (sslStateElement === null || sslStateElement === undefined || sslStateElement.length === 0) === false) {
          ...
          if (lastModifiedTimeUtcElement !== null && lastModifiedTimeUtcElement !== undefined && (lastModifiedTimeUtcElement === null || lastModifiedTimeUtcElement === undefined || lastModifiedTimeUtcElement.length === 0) === false) {
          ...
          if (runtimeAvailabilityStateElement !== null && runtimeAvailabilityStateElement !== undefined && (runtimeAvailabilityStateElement === null || runtimeAvailabilityStateElement === undefined || runtimeAvailabilityStateElement.length === 0) === false) {
          ...
          if (usageStateElement !== null && usageStateElement !== undefined && (usageStateElement === null || usageStateElement === undefined || usageStateElement.length === 0) === false) {
  ...
  WebSiteOperations.prototype.createRepository = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/repository';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.delete = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '?';
   ...
   * backup.
   * 
   * @param {boolean} restoreRequest.ignoreConflictingHostNames When restoring
   * a site, custom domains might conflict with other site in the same
   * datacenter. If this value is true, such hostnames will be ignored during
   * restore. If this is false, the restore operation will fail on such
   * conflict.
   * 
  ...
  WebSiteOperations.prototype.discover = function(webSpaceName, webSiteName, restoreRequest, callback) {
    ...
    if (restoreRequest.adjustConnectionStrings === null || restoreRequest.adjustConnectionStrings === undefined) {
      return callback(new Error('restoreRequest.adjustConnectionStrings cannot be null.'));
    }
    if (restoreRequest.ignoreConflictingHostNames === null || restoreRequest.ignoreConflictingHostNames === undefined) {
      return callback(new Error('restoreRequest.ignoreConflictingHostNames cannot be null.'));
    }
    if (restoreRequest.overwrite === null || restoreRequest.overwrite === undefined) {
      return callback(new Error('restoreRequest.overwrite cannot be null.'));
    }
    
    // Tracing
    
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/restore/discover';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (restoreRequestElement2 !== null && restoreRequestElement2 !== undefined) {
          ...
          if (overwriteElement2 !== null && overwriteElement2 !== undefined) {
          ...
          if (ignoreConflictingHostNamesElement2 !== null && ignoreConflictingHostNamesElement2 !== undefined) {
          ...
          if (adjustConnectionStringsElement2 !== null && adjustConnectionStringsElement2 !== undefined) {
  ...
  WebSiteOperations.prototype.generatePassword = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/newpassword';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.getBackupConfiguration = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/backup/config';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (backupRequestElement !== null && backupRequestElement !== undefined) {
          ...
          if (backupScheduleElement !== null && backupScheduleElement !== undefined) {
            ...
            if (frequencyIntervalElement !== null && frequencyIntervalElement !== undefined) {
            ...
            if (frequencyUnitElement !== null && frequencyUnitElement !== undefined) {
            ...
            if (keepAtLeastOneBackupElement !== null && keepAtLeastOneBackupElement !== undefined) {
            ...
            if (lastExecutionTimeElement !== null && lastExecutionTimeElement !== undefined && (lastExecutionTimeElement === null || lastExecutionTimeElement === undefined || lastExecutionTimeElement.length === 0) === false) {
            ...
            if (retentionPeriodInDaysElement !== null && retentionPeriodInDaysElement !== undefined) {
            ...
            if (startTimeElement !== null && startTimeElement !== undefined && (startTimeElement === null || startTimeElement === undefined || startTimeElement.length === 0) === false) {
              var startTimeInstance = new Date(startTimeElement);
  ...
  WebSiteOperations.prototype.getConfiguration = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/config';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.getHistoricalUsageMetrics = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/metrics?';
    if (parameters.metricNames !== null && parameters.metricNames !== undefined && parameters.metricNames.length > 0) {
      url2 = url2 + '&names=' + encodeURIComponent(parameters.metricNames.join(','));
    }
    if (parameters.startTime !== null && parameters.startTime !== undefined) {
  ...
  WebSiteOperations.prototype.getInstanceIds = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/instanceids';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.getPublishProfile = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/publishxml';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.getSlotConfigNames = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/slotConfigNames';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.getUsageMetrics = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/usages';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
        ...
        if (usagesElement !== null && usagesElement !== undefined) {
          if (usagesElement !== null && usagesElement !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, usagesElement, 'USAGE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (computeModeElement !== null && computeModeElement !== undefined) {
              ...
              if (nextResetTimeElement !== null && nextResetTimeElement !== undefined) {
              ...
              if (siteModeElement !== null && siteModeElement !== undefined) {
  ...
  WebSiteOperations.prototype.isHostnameAvailable = function(webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?';
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (booleanElement !== null && booleanElement !== undefined) {
  ...
  WebSiteOperations.prototype.listBackups = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/restore';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.resetSlotConfiguration = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/resetSlotConfig';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.restart = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/restart';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.syncRepository = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/repository?action=sync';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
        ...
        if (siteElement2 !== null && siteElement2 !== undefined) {
          ...
          if (hostNameSslStatesSequenceElement2 !== null && hostNameSslStatesSequenceElement2 !== undefined) {
            for (var loweredIndex5 = 0; loweredIndex5 < js2xml.getElements(responseDoc, hostNameSslStatesSequenceElement2, 'HOSTNAMESSLSTATE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex5 = loweredIndex5 + 1) {
              ...
              if (sslStateElement2 !== null && sslStateElement2 !== undefined && (sslStateElement2 === null || sslStateElement2 === undefined || sslStateElement2.length === 0) === false) {
...
var WebSpaceOperations = ( /** @lends WebSpaceOperations */ function() {
  ...
  WebSpaceOperations.prototype.createPublishingUser = function(username, password, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?properties=publishingCredentials';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSpaceOperations.prototype.get = function(webSpaceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (webSpaceElement !== null && webSpaceElement !== undefined) {
          ...
          if (availabilityStateElement !== null && availabilityStateElement !== undefined) {
            var availabilityStateInstance = availabilityStateElement;
          ...
          if (currentNumberOfWorkersElement !== null && currentNumberOfWorkersElement !== undefined && (currentNumberOfWorkersElement === null || currentNumberOfWorkersElement === undefined || currentNumberOfWorkersElement.length === 0) === false) {
            var isNil = false;
          ...
          if (currentWorkerSizeElement !== null && currentWorkerSizeElement !== undefined && (currentWorkerSizeElement === null || currentWorkerSizeElement === undefined || currentWorkerSizeElement.length === 0) === false) {
            var isNil2 = false;
  ...
  WebSpaceOperations.prototype.getDnsSuffix = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?properties=dnssuffix';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSpaceOperations.prototype.listGeoRegions = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?properties=georegions';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (geoRegionsSequenceElement !== null && geoRegionsSequenceElement !== undefined) {
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, geoRegionsSequenceElement, 'GEOREGION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (sortOrderElement !== null && sortOrderElement !== undefined && (sortOrderElement === null || sortOrderElement === undefined || sortOrderElement.length === 0) === false) {
              var isNil = false;
  ...
  WebSpaceOperations.prototype.listPublishingUsers = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?properties=publishingUsers';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
