...
var JobOperations = ( /** @lends JobOperations */ function() {
  ...
  JobOperations.prototype.create = function(parameters, callback) {
    ...
    // Construct URL
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/cloudservices/' + this.client.cloudServiceName.trim() + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName.trim() + '/jobs?';
  ...
  JobOperations.prototype.createOrUpdate = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/cloudservices/' + this.client.cloudServiceName.trim() + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName.trim() + '/jobs/' + jobId.trim() + '?';
    url2 = url2 + 'api-version=2014-04-01';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  JobOperations.prototype.getHistory = function(jobId, parameters, callback) {
    ...
    // Construct URL
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/cloudservices/' + this.client.cloudServiceName.trim() + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName.trim() + '/jobs/' + jobId.trim() + '/history?';
    url2 = url2 + 'api-version=2014-04-01';
  ...
  JobOperations.prototype.getHistoryWithFilter = function(jobId, parameters, callback) {
    ...
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/cloudservices/' + this.client.cloudServiceName.trim() + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName.trim() + '/jobs/' + jobId.trim() + '/history?';
    url2 = url2 + 'api-version=2014-04-01';
    url2 = url2 + '&$filter=status eq ' + encodeURIComponent(parameters.status !== null && parameters.status !== undefined ? parameters.status.toString() : 'Completed');
    if (parameters.skip !== null && parameters.skip !== undefined) {
      url2 = url2 + '&$skip=' + encodeURIComponent(parameters.skip.toString());
    }
    if (parameters.top !== null && parameters.top !== undefined) {
  ...
  JobOperations.prototype.listWithFilter = function(parameters, callback) {
    ...
    var url2 = (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/cloudservices/' + this.client.cloudServiceName.trim() + '/resources/scheduler/~/JobCollections/' + this.client.jobCollectionName.trim() + '/jobs?';
    url2 = url2 + 'api-version=2014-04-01';
    url2 = url2 + '&$filter=state eq ' + encodeURIComponent(parameters.state !== null && parameters.state !== undefined ? parameters.state.toString() : 'Enabled');
    if (parameters.skip !== null && parameters.skip !== undefined) {
      url2 = url2 + '&$skip=' + encodeURIComponent(parameters.skip.toString());
    }
    if (parameters.top !== null && parameters.top !== undefined) {
