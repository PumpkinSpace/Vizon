...
var PermissionOperations = ( /** @lends PermissionOperations */ function() {
  ...
  PermissionOperations.prototype.listForResourceGroup = function(resourceGroupName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourcegroups/' + resourceGroupName.trim() + '/providers/Microsoft.Authorization/permissions?';
    url2 = url2 + 'api-version=2014-07-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
...
var RoleAssignmentOperations = ( /** @lends RoleAssignmentOperations */ function() {
  ...
  RoleAssignmentOperations.prototype.list = function(parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers/Microsoft.Authorization/roleAssignments?';
    var appendFilter = true;
    if (parameters !== null && parameters !== undefined && parameters.atScope === true) {
      appendFilter = false;
  ...
  RoleAssignmentOperations.prototype.listForResourceGroup = function(resourceGroupName, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/resourceGroups/' + (resourceGroupName !== null && resourceGroupName !== undefined ? resourceGroupName.trim() : '') + '/providers/Microsoft.Authorization/roleAssignments?';
    var appendFilter = true;
    if (parameters !== null && parameters !== undefined && parameters.atScope === true) {
      appendFilter = false;
      url2 = url2 + '$filter=atScope()';
...
var RoleDefinitionOperations = ( /** @lends RoleDefinitionOperations */ function() {
  ...
  RoleDefinitionOperations.prototype.get = function(roleDefinitionName, callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers/Microsoft.Authorization/roleDefinitions/' + roleDefinitionName + '?';
    url2 = url2 + 'api-version=2014-07-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
  ...
  RoleDefinitionOperations.prototype.list = function(callback) {
    ...
    // Construct URL
    var url2 = '/subscriptions/' + (this.client.credentials.subscriptionId !== null && this.client.credentials.subscriptionId !== undefined ? this.client.credentials.subscriptionId.trim() : '') + '/providers/Microsoft.Authorization/roleDefinitions?';
    url2 = url2 + 'api-version=2014-07-01-preview';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
